...
export default function FAQPage() {
    ...
    return (
        <main className="min-h-screen bg-background" data-oid=".xi_48r">
            <div
                className="fixed top-0 left-0 w-full h-12 bg-background/80 backdrop-blur-sm z-50"
                data-oid="bz48gzv"
            >
                <TopBar data-oid=":ednh7g" />
            </div>
            <div className="w-full max-w-6xl mx-auto py-32 px-4 md:px-8" data-oid="nlynzgm">
                <h1
                    className="text-foreground-primary text-[4vw] leading-[1.1] font-light mb-16 max-w-3xl text-balance"
                    data-oid="x_bxfa8"
                >
                    Frequently Asked <br data-oid="ugzhpj8" />
                    Questions
                </h1>
                <div
                ...
                >
                    {/* FAQ Content */}
                    <section
                        className="flex-1 pr-0 md:pr-8 md:border-r md:border-foreground-tertiary/30"
                        data-oid="ibhotrh"
                    >
                        {faqSections.map((section, i) => (
                            ...
                            >
                                <h2
                                    className="text-foreground-secondary text-large mb-4 text-balance"
                                    data-oid="cmsf_sp"
                                >
                                    {section.title}
                                </h2>
                                <FAQDropdown faqs={section.faqs} data-oid="dkk_our" />
                            </div>
                        ))}
                    </section>
                    ...
                    <aside
                        ...
                        data-oid="dckau:1"
                    >
                        <div ref={sidebarRef} style={sidebarStyle} data-oid="ub638u1">
                            <div className="flex flex-row items-start group" data-oid="4doyy6h">
                                {/* Sidebar List */}
                                <ul className="flex flex-col gap-4" data-oid="kmm54gr">
                                    {faqSections.map((section, i) => (
                                        <li key={section.anchor} data-oid="u6c01wh">
                                            <a
                                                href={`#${section.anchor}`}
