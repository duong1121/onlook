...
export const TopBar = observer(({ frame }: { frame: WebFrame }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Link className="ml-auto" href={frame.url} target="_blank" data-oid="zj1lc_e">
                    <Button variant="ghost" size="icon" data-oid="775t5-i">
                        <Icons.ExternalLink data-oid="_eq:amg" />
                    </Button>
                </Link>
            </div>
        </div>
