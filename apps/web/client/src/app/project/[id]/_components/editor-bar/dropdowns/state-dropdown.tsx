...
export const StateDropdown = () => {
    return (
        <DropdownMenu data-oid="ylzhxrz">
            <DropdownMenuTrigger asChild data-oid="bt_yd_.">
                <Button
                    variant="ghost"
                    size="toolbar"
                    ...
                    data-oid="_sidzmk"
                >
                    <Icons.StateCursor className="h-4 w-4 min-h-4 min-w-4" data-oid="1j95r88" />
                    <span className="text-sm" data-oid="bhxrrdw">
                        State
                    </span>
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent
                align="start"
                className="min-w-[120px] mt-1 p-1 rounded-lg"
                data-oid="avqr8ia"
            >
                <DropdownMenuItem
