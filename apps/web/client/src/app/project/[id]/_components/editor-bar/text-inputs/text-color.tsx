...
export const TextColor = observer(() => {
    ...
    return (
        <DropdownMenu open={isOpen} onOpenChange={onOpenChange} data-oid="7ml:4rz">
            <HoverOnlyTooltip
                content="Text Color"
                side="bottom"
                className="mt-1"
                ...
                data-oid="e4reiu-"
            >
                <DropdownMenuTrigger asChild data-oid="wn103yb">
                    <Button
                        variant="ghost"
                        size="toolbar"
                        ...
                        data-oid="ct:.:p_"
                    >
                        <Icons.TextColorSymbol className="h-3.5 w-3.5" data-oid="oi3iek6" />
                        <div
