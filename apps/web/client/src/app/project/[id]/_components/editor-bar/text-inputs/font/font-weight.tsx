...
export const FontWeightSelector = observer(() => {
    ...
    return (
        <DropdownMenu open={isOpen} onOpenChange={onOpenChange} data-oid="muuam4:">
            <HoverOnlyTooltip
                content="Font Weight"
                side="bottom"
                className="mt-1"
                ...
                data-oid="nk4o0hl"
            >
                <DropdownMenuTrigger asChild data-oid="1hzwnrg">
                    <Button
                        variant="ghost"
                        size="toolbar"
                        ...
                        data-oid="y3d7t0c"
                    >
                        <span className="text-smallPlus" data-oid="_dm01xb">
