...
export function CodeOneToOneSection() {
    ...
    return (
        <section
            className="relative w-full flex justify-center bg-transparent min-h-[480px] max-w-6xl mx-auto px-8"
            data-oid="9wdvf8o"
        >
            <div
                className="absolute left-0 top-0 w-full max-w-6xl mx-auto z-10 pointer-events-none"
                data-oid="zmazd23"
            >
                <h2
                    className="text-white text-[4vw] leading-[1.1] font-light max-w-4xl text-left ml-12 drop-shadow-xl"
                    data-oid="2ajisiz"
                >
                    Truly one-to-one
                    <br data-oid="24c.m:w" />
            ...
            >
                {/* Left: Mock Website */}
                <div
                    className="relative bg-white rounded-2xl shadow-xl w-full max-w-[800px] h-[320px] flex flex-col items-center justify-center z-10"
                    data-oid="8-nh45."
                >
                    <div
                        className="w-full h-full flex flex-col justify-between p-8 gap-6"
                        data-oid="3hhawaa"
                    >
                        {mockDivs.map((div) => (
                            <div
                                ...
                                data-oid="aqw7fm2"
                            >
                                <span className="text-gray-800" data-oid="i3426dk">
                                    {div.label}
                                </span>
                            </div>
                        ))}
                ...
                >
                    <div
                        className="backdrop-blur-xl bg-background/80 border border-border/10 border-[0.5px] rounded-2xl shadow-xl shadow-black/40 p-3 w-[440px] h-[400px] flex flex-col text-left text-small font-mono text-foreground-secondary relative overflow-hidden"
                        data-oid="eczp-::"
                    >
                        <div
                            className="absolute inset-0 pointer-events-none rounded-2xl border border-white/10 shadow-2xl p-5"
                            data-oid="q_.ylxl"
                        >
                            <pre className="relative z-10 whitespace-pre-wrap" data-oid="l6haw:2">
